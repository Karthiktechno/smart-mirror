...
<head>
    ...
    <style>
        ...
        * {
        ...
        .apps {
            grid-area: apps;
            background: linear-gradient(135deg, rgba(156, 136, 255, 0.1) 0%, rgba(124, 77, 255, 0.1) 100%);
        ...
        .app-icon:hover {
            ...
            box-shadow: 0 20px 40px rgba(156, 136, 255, 0.4);
        }
        ...
        .action-button:hover {
            ...
            box-shadow: 0 12px 30px rgba(156, 136, 255, 0.5);
        }
        ...
        @media (max-width: 768px) {
            ...
            .apps {
                ...
                margin-top: 20px;
                border-radius: 20px;
                background: linear-gradient(135deg, rgba(156, 136, 255, 0.15) 0%, rgba(124, 77, 255, 0.15) 100%);
